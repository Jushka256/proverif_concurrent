...
val is_event : predicate -> bool
val is_attacker : predicate -> bool
...
val get_vars_acc : binder list ref -> term -> unit
val get_vars_acc_constra : binder list ref -> constraints -> unit
val get_vars_acc_fact : binder list ref -> fact -> unit
val get_vars_acc_format : binder list ref -> format -> unit 
