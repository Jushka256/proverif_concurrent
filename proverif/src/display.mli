...
val requires_liveness : bool ref
...
module type LangSig =
  sig
    ...
    val display_lemma_link : lemma -> unit
    ...
    val leq_connective : string
    val le_connective : string
    val hline : string
...
sig
  ...
  val display_ordered_fact : fact * binder option -> unit
...
module LangDisp : functor (_ : LangSig) -> LangDispSig
