...
val string_of_pval : Ptree.pval -> string

val verbose_base : t_verbose_base ref
...
val sat_application : bool ref
val verif_application : bool ref

val conclusion_before_premise : bool ref

val ordered_saturation : bool ref 
  (** When [true] we apply ordered saturation even if not necessary. Note that setting to [false]
      does not prevent ordered saturation. In particular, ordered saturation will be applied when
...
val nounif_ignore_conclusion : bool ref
